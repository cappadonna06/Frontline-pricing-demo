...
// ✅ multipliers live inside the component
...
const aseAnnual = Math.round(aseAnnualRaw * aseMultiplier); // AFTER multiplier
  ...
  // -----------------------------
// ✅ Subscription (monthly) — uses base by family * multiplier
...
<p className="text-xs text-muted-foreground mt-2">
  System type dictated by system design, LV2 for &gt;9 zone and high-flow applications.
</p>
            </div>
          </CardContent>
        </Card>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-muted-foreground">
                ...
                <th className="py-2 text-right">Total Cash In</th>
                <th className="py-2 text-right">Cumulative Cash In</th>
              </tr>
            </thead>
            <tbody>
              {rows.map((r) => (
